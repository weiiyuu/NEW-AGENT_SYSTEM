# scripts/generate_test_data_weekly.py
import pandas as pd
import random
...
# ---------- 參數 ----------
end_date = datetime(2025, 11, 24)  # 週報日期
start_date = end_date - timedelta(days=6)  # 過去 7 天
...
# ---------- 存檔 ----------
df.to_csv("data/master_test_weekly.csv", index=False, encoding="utf-8-sig")
print(f"✅ Weekly 模擬資料生成完成，共 {len(df)} 筆文章")
